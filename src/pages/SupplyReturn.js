    ...
    render() {
        return (
            ...
            <div className='table_holder'>
                ...
                <ButtonsWrapper from={'normal'} fetchFast={'supplyreturns'} buttonsName={buttonsNames} activeitem={this.props.state.navbar.activeItem} activesubitem={this.props.state.navbar.activeSubItem} />
