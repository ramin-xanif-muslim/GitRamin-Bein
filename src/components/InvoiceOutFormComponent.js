...
const mapDispatchToProps = {
    putData, getMarks, getCustomersData, updateCustomerSelect, isCreated, createNewDocId, saveDocument, deleteResponseService, getProductsModal, getProductsGroupModal, getGroups, getStocksGroupsModal, getCustomers, getCustomersFast, putLocalStates, getCustomerGroupsModal
}

export default connect(mapStateToProps, mapDispatchToProps)(LoaderHOC(InvoiceOutFormComponent, 'datas'))
