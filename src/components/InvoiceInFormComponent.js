...
const mapDispatchToProps = {
    putData, getMarks, createNewDocId, getCustomersData, saveDocument, deleteResponseService, isCreated, getProductsModal, getProductsGroupModal, getGroups, getStocksGroupsModal, getCustomers, getCustomersFast, putLocalStates, getCustomerGroupsModal

}

export default connect(mapStateToProps, mapDispatchToProps)(LoaderHOC(InvoiceInFormComponent, 'datas'))
