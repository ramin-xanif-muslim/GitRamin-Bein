            ...
            <div className='table_holder'>
                <Row className='filter_table_wrapper_row doc'>
                    ...
                    <Col className='page_name_wrapper' xs={24} md={24} xl={24}>
                        <h2 className='custom_top_margin'><Trans word={'Sale'} /></h2>
                    </Col>
                    ...
                    <SaleFormComponent doctype={'Sale Number'} docid={this.props.state.datas.doc[0].Id} doc={this.props.state.datas.doc[0]} />
