...
class PaymentInFormComponent extends Component {
    ...
    onFinish = (values) => {
        ...
        if (this.state.selectedCustomerId === '') {
            delete sendObject['customerid'];
            sendObject.customerid = this.props.saledoc.selectCustomerName ? this.props.saledoc.selectCustomerId : this.props.saledoc ? this.props.saledoc.doc.CustomerId : this.props.doc.CustomerId
        }
...
const mapDispatchToProps = {
    putData, getMarks, createNewDocId, isCreated, getCustomersData, saveDocument, deleteResponseService, getProductsModal, getProductsGroupModal, getGroups, getStocksGroupsModal, getCustomers, getCustomersFast, putLocalStates, getCustomerGroupsModal

}

export default connect(mapStateToProps, mapDispatchToProps)(LoaderHOC(PaymentInFormComponent, 'datas'))
