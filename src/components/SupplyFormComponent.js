...
import { saveDocument, progress, isCreated, updateSelectedCustomer } from '../actions/putAactions/saveDocument';
...
import {
    Form, Input, Drawer, Button, message, InputNumber, TreeSelect, Checkbox, Dropdown, DatePicker, Switch, Select, Spin, Tag, Divider, Menu, Col, Row, Collapse
} from 'antd';
...
class SupplyFormComponent extends Component {
    ...
    onFinish = (values) => {
        ...
        if (this.state.selectedCustomerId === '') {
            delete sendObject['customerid'];
            sendObject.customerid = this.props.doc.CustomerId
        }
        ...
        progress(true)
        this.props.saveDocument('supplies', sendObject)
        this.props.updateSelectedCustomer(this.state.selectedCustomerId, this.state.selectedCustomerName)
...
const mapDispatchToProps = {
    putData, getMarks, getCustomersData, updateSelectedCustomer, putMark, delMark, createNewDocId, saveDocument, isCreated, updateCustomerSelect, deleteResponseService, getProductsModal, getProductsGroupModal, getGroups, getStocksGroupsModal, getCustomers, getCustomersFast, putLocalStates, getCustomerGroupsModal, changeForm
}
