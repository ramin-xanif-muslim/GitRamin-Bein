...
class CreateDemandForm extends Component {
    ...
    render() {
        ...
        const check = (
            <Menu>
                <Menu.Item key="0">
                    <Link to={{ pathname: '/invoice', search: `${this.props.id}`, hash: "demands" }} onClick={this.handlePageCheck} target={'_blank'} >A4</Link>
                ...
                <Menu.Item key="2">
                    <Link to={{ pathname: '/check80', search: `${this.props.id}`, hash: "demands" }} onClick={this.handlePageCheck} target={'_blank'} >80mm </Link>
