...
class DemandFormComponent extends Component {
    ...
    onFinish = (values) => {
        ...
        this.props.saveDocument('demands', sendObject)
                            ...
                            <Col xs={24} md={24} xl={6}>
                                <div className='second_form_wrapper'>
                                    ...
                                    <div className='plus_wrapper'>
                                        ...
                                        <PlusOutlined style={{ margin: '0', display: this.props.saledoc ? 'none' : 'flex' }} onClick={this.showDrawer} className='add_elements' />
...
const mapDispatchToProps = {
    putData, updateSelectedCustomer, getMarks, getCustomersData, putMark, delMark, createNewDocId, saveDocument, isCreated, updateCustomerSelect, deleteResponseService, getProductsModal, getProductsGroupModal, getGroups, getStocksGroupsModal, getCustomers, getCustomersFast, putLocalStates, getCustomerGroupsModal, changeForm
}
