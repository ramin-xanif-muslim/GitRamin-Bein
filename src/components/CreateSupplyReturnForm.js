...
class CreateSupplyReturnForm extends Component {
    ...
    render() {
        ...
        const check = (
            <Menu>
                <Menu.Item key="0">
                    <Link to={{ pathname: '/invoice', search: `${this.props.id}`, hash: "supplyreturns" }} target={'_blank'} onClick={this.handlePageCheck} >A4</Link>
                ...
                <Menu.Item key="2">
                    <Link to={{ pathname: '/check80', search: `${this.props.id}`, hash: "supplyreturns" }} target={'_blank'} onClick={this.handlePageCheck} >80mm </Link>
            ...
            <div className='table_holder'>
                <Row className='filter_table_wrapper_row doc'>
                    ...
                    <Col xs={24} md={24} xl={24} className='form_header_wrapper'>
                        ...
                        <DocButtons errorFields={errorFields} from={this.props.fromdoc ? this.props.fromdoc : 'p=supplyreturns'} linkedDocs={this.props.state.datas.doc ? true : false} doc={this.props.state.datas.doc} toDoc='createPaymentOut' fromDoc='createSupplyReturn' buttonsName={buttonsNames} activeitem={this.props.state.navbar.activeItem} activesubitem={this.props.state.navbar.activeSubItem} />
                    ...
                    <SupplyReturnFormComponent docid={this.props.id ? this.props.state.datas.doc[0].Id : ''} datas={this.props.state.groups.groups} saledoc={this.props.saledoc} doc={this.props.id ? this.props.state.datas.doc[0] : ''} />
                    <Col xs={24} md={24} xl={24}>
                        <DocTable visible={this.state.visible} linkedid={this.props.id ? this.props.state.datas.doc[0].Id : ''} from='supplyreturns' saledoc={this.props.saledoc} doc={this.props.id ? this.props.state.datas.doc[0] : ''} handleProduct={this.props.state.handleProduct.selectedProduct} datasource={this.props.id ? this.props.state.datas.doc[0].Positions : this.props.saledoc ? this.props.saledoc.doc.Positions : ''} />
                    </Col>
                </Row >
...
export default connect(mapStateToProps, mapDispatchToProps)(LoaderDocHOC(CreateSupplyReturnForm, 'fetching'))