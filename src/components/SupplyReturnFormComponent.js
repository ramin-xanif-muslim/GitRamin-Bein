    ...
    render() {
        ...
        return (
            ...
            <>
                ...
                <CreateCustomerModal from='createSupplyReturn' visible={this.state.visibleCustomer} childrenDrawer={this.state.childrenDrawer} onClose={this.onClose} showChildrenDrawer={this.showChildrenDrawer} onChildrenDrawerClose={this.onChildrenDrawerClose} />
...
export default connect(mapStateToProps, mapDispatchToProps)(LoaderHOC(SupplyReturnFormComponent, 'datas'))
